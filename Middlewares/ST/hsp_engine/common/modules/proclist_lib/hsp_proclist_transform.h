...
/** @defgroup HSP_MODULES_PROCLIST_TRANSFORM_LIBRARY HSP Proclist Transform Functions
  * @{
  */
/* Exported functions --------------------------------------------------------*/
/** @defgroup HSP_Transform_Exported_Functions HSP Transform Exported Functions
  * @{
  */
